                    ...
                    <div className="contact-info">
                      ...
                      <div className="absolute inset-0">
                        <div className="flex flex-col justify-center items-center h-full">
                          <span className="text-lg text-white font-bold m-1">
                            Did you like what you see?
                          </span>
                          <span className="text-sm text-white m-1">
                            Contact the seller now to negotiate!
                          </span>
                          <span className="m-2">
                            {session.data && (
                              <a href={`tel:+254${ad.contactNumber}`}>
                                <button className="bg-emerald-500 hover:bg-emerald-700 text-white py-2 px-4 opacity-100 rounded-lg flex items-center">
                            ...
                            {!session.data && (
                              <button
                                className="bg-emerald-500 hover:bg-emerald-700 text-white py-2 px-4 opacity-100 rounded-lg flex items-center"
                                onClick={() => signIn()}
                              >
                                <CallIcon sx={{ marginRight: "5px" }} />
                                Show contact
                          ...
                          <span className="m-2">
                            {session.data && (
                              <a href={`tel:+254${ad.contactNumber}`}>
                                <button className="bg-emerald-100 hover:bg-emerald-200 text-emerald-700 py-2 px-10 opacity-100 rounded-lg flex items-center">
